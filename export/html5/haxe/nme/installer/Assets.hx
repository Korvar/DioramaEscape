...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/1GAMicon.svg", "assets/1GAMicon.svg");
			...
			resourceNames.set ("assets/data/pointers.png", "assets/data/pointers.png");
			resourceTypes.set ("assets/data/pointers.png", "image");
			
			
			resourceNames.set ("assets/data/SamuraiCloseup01.jpg", "assets/data/SamuraiCloseup01.jpg");
			resourceTypes.set ("assets/data/SamuraiCloseup01.jpg", "image");
			
			
			resourceNames.set ("assets/data/SamuraiCloseupMempoMoved01.jpg", "assets/data/SamuraiCloseupMempoMoved01.jpg");
			resourceTypes.set ("assets/data/SamuraiCloseupMempoMoved01.jpg", "image");
			
			
			resourceNames.set ("assets/data/SamuraiWideAngle.jpg", "assets/data/SamuraiWideAngle.jpg");
			...
			resourceNames.set ("assets/data/S_pointer.png", "assets/data/S_pointer.png");

...
class ApplicationMain {
	...
	public static function main () {
		...
		urlLoaders.set ("assets/1GAMicon.svg", urlLoader);
		total ++;
		...
		var loader:Loader = new Loader ();
		loaders.set ("assets/data/pointers.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader ();
		loaders.set ("assets/data/SamuraiCloseup01.jpg", loader);
		total ++;
		
		
		var loader:Loader = new Loader ();
		loaders.set ("assets/data/SamuraiCloseupMempoMoved01.jpg", loader);
		total ++;
		
		
		var loader:Loader = new Loader ();
		loaders.set ("assets/data/SamuraiWideAngle.jpg", loader);
		total ++;
		...
		var loader:Loader = new Loader ();
		loaders.set ("assets/data/S_pointer.png", loader);
		total ++;
